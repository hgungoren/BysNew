...
namespace ToksozBysNew.Migrations
{
    ...
    [Migration("20230126071232_Updated_InvoiceDetail_23012610114065")]
    partial class UpdatedInvoiceDetail23012610114065
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToksozBysNew.DenemeDetails.DenemeDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DetailNetValue")
                        .HasColumnType("int")
                        .HasColumnName("DetailNetValue");
                    ...
                    b.ToTable("AppDenemeDetails", (string)null);
                });

            modelBuilder.Entity("ToksozBysNew.Denemes.Deneme", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DenemeName")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("DenemeName");

                    b.Property<int>("DenemeSayi")
                        .HasColumnType("int")
                        .HasColumnName("DenemeSayi");

                    b.Property<decimal>("DenemeValue")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("DenemeValue");
                    ...
                    b.ToTable("AppDenemes", (string)null);
                });
            ...
            modelBuilder.Entity("ToksozBysNew.InvoiceDetails.InvoiceDetail", b =>
                {
                    ...
                    b.Property<DateTime>("InvoicePaymentDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("InvoicePaymentDate");
            ...
            modelBuilder.Entity("ToksozBysNew.DenemeDetails.DenemeDetail", b =>
                {
                    b.HasOne("ToksozBysNew.Denemes.Deneme", "Deneme")
                        .WithOne("DenemeDetail")
                        .HasForeignKey("ToksozBysNew.DenemeDetails.DenemeDetail", "DenemeId")
            ...
            modelBuilder.Entity("ToksozBysNew.Invoices.Invoice", b =>
                {
                    b.HasOne("ToksozBysNew.InvoiceDetails.InvoiceDetail", "InvoiceDetail")
                        .WithMany()
